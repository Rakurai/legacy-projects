...
1. **Discovery & Inventory**
   ...
   - Deliverables: `projects/doc_gen/files_old.md` (initial directory without categories or summaries), `projects/doc_gen/files_docs.md`, `projects/doc_gen/dependency_graph.md`, discovery report.
2. **Header File Summarization**
   ...
   - Use `projects/doc_gen/files_old.md` for file context and update it with new summaries and insights as each file is processed.
   - Reference `projects/doc_gen/dependency_graph.md` for static dependency context.
   - Store batch and module summaries in `projects/doc_gen/summary_headers_batch_X.md` and `projects/doc_gen/summary_headers.md`.
3. **Implementation File Summarization**
   ...
   - Use `projects/doc_gen/files_old.md` for file context and update it with new summaries and insights as each file is processed.
   - Reference `projects/doc_gen/dependency_graph.md` for static dependency context.
   - Store batch and module summaries in `projects/doc_gen/summary_impl_batch_X.md` and `projects/doc_gen/summary_impl.md`.
4. **Combine & Integrate Results**
   ...
   - Update `docs/component_summaries.md`, `docs/architecture_overview.md`, and `docs/system_overview.md` as needed.
5. **Documentation & Planning**
   ...
   - Deliverables: Updated documentation corpus in `docs/`, migration plan, architecture recommendations, and summary documents.

## Workflow & Iteration
- Each phase and batch follows a cycle: review, Q/A, action plan, execution, and documentation update.
- Use `projects/doc_gen/files_old.md` as a living document, updating it with new file summaries and insights as discovered in each stage.
- Use `projects/doc_gen/dependency_graph.md` as a static reference for file/module relationships throughout the documentation process.
- All findings, decisions, and changes are documented in `docs/` and project logs.
