...
1. Refresh your understanding of the older files in `projects/doc_gen/old_component_groups/`.
2. Refresh your understanding of the source file summaries in `projects/doc_gen/files_old.json`.
...
- Do not search the codebase or read source files, only use the existing documentation in `projects/doc_gen/old_component_groups/` and `projects/doc_gen/files_old.json`. (we will handle that in a later step)
...
- Reference the file inventory in `projects/doc_gen/files_old.json` for details.
