...
# Default paths for resources (code_graph.* live alongside this module)
_MODULE_DIR = Path(os.path.dirname(os.path.abspath(__file__)))
DEFAULT_GRAPH_PATH = _MODULE_DIR / "code_graph.gml"
DEFAULT_DB_PATH = _MODULE_DIR / "code_graph.json"
